...
public class TestBloomFilter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(bloomFilter.contains("99999999"));
        ...
        System.out.println(bloomFilter.contains("55555555"));
        long end = System.currentTimeMillis();
        System.out.println(end);
        System.out.println("判断5324512515是否在线使用了: " + (begin - end) + "ms");
    }
}
